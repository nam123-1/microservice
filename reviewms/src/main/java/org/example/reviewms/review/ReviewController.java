...
// @RequestParam ( được sử dụng khi thông tin được truyền qua query parameters trong URL )
// GET /reviews?companyId={companyId}
// POST /reviews?companyId={companyId}

// @PathVariable ( được sử dụng khi thông tin được truyền qua phần path của URL. )
